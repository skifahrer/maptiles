...
def kde_su_glyfy(man):
    ...
    v hlavičke súboru) –, je to odpoveď na otázku, ktorú si nad menším balíkom
    položí každý: „a kde teda sú?“. Appka ich má v sebe vždy; web podľa toho,
    čo si štýl pýta, a to je v manifeste.
    """
