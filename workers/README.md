...
| **výška križovatiek v smerovacej sieti** | **ÚGKK DMR 5.0, 5 m** | `<kraj>-routing.pmtiles`, odoberá [`workers/routing/vysky.py`](routing/vysky.py) zo skladu `dem-dmr5-v2`; iný model cez `ROUTING_DEM_SOURCE` |
